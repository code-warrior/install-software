...
VSCODE_EXTENSIONS=("editorconfig.editorconfig" "vscjava.vscode-java-pack" "VisualStudioExptTeam.vscodeintellicode" "redhat.java" "vscjava.vscode-java-dependency" "SonarSource.sonarlint-vscode" "shengchen.vscode-checkstyle")
